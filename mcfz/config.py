...
class Config:
    ...
    Use the fast C++ reporter (still experimental). """

    keep_stage4_files: bool = False
    _help += """\n\n keep_stage4_files (False)
    Keep all the files generated by the fast detector in stage4. """
    ...
    def _set_from_yaml(self, yaml_data: YAMLData) -> None:
        ...
        self.use_fast_detector = yaml_data.get("use_fast_detector", self.use_fast_detector)
        self.keep_stage4_files = yaml_data.get("keep_stage4_files", self.keep_stage4_files)
