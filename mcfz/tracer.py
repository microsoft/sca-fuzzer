...
class CoverageCollectionException(Exception):
    """ Exception raised when coverage collection fails during execution. """
...
class Tracer:
    ...
    def _execute(self, expanded_str: str, input_name: str, output_base: str,
        ...
        :return: None
        :raise: InstrException, ProgramException, CoverageCollectionException
        """
        ...
        try:
            ...
            raise CoverageCollectionException()
