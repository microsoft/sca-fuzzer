...
- [General Guidelines](contributing/guidelines-general.md): Development environment setup, testing procedures, contribution workflow
- [Code Style](contributing/guidelines-code-style.md): Formatting conventions for Python and C code, naming conventions
- [Git Workflow](contributing/guidelines-git.md): Branch management, commit message format, merge procedures
