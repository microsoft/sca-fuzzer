...
for each actor in the test case. This object can be serialized into Revizor's custom binary format ([RDBF](binary-formats.md)) for consumption by the model and executor.
