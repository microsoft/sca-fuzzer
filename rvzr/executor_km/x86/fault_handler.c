...
void run_experiment_handler(void);
void nmi_handler(void);

__attribute__((unused)) void run_experiment_outer_(void);
__attribute__((unused)) void run_experiment_handler_wrapper(void);
...
MULTI_ENTRY_HANDLER_DECLARATIONS(run_experiment_handler);
static void *run_experiment_handlers[] = {
    MULTI_ENTRY_HANDLER_LIST(run_experiment_handler) NULL,
};
...
// =================================================================================================
// run_experiment_outer: a wrapper that gracefully handles bugs in measurement.c:run_experiment
// =================================================================================================
...
{
    static uint64_t fault_data[6] = {0};
    MULTI_ENTRY_HANDLER(run_experiment_handler);
    asm volatile(".global run_experiment_handler\n"
